...
00000000006030f0 <n1>:
  6030f0:	24 00 00 00 00 00 00 00 10 31 60 00 00 00 00 00     $........1`.....
  603100:	30 31 60 00 00 00 00 00 00 00 00 00 00 00 00 00     01`.............

0000000000603110 <n21>:
  603110:	08 00 00 00 00 00 00 00 90 31 60 00 00 00 00 00     .........1`.....
  603120:	50 31 60 00 00 00 00 00 00 00 00 00 00 00 00 00     P1`.............

0000000000603130 <n22>:
  603130:	32 00 00 00 00 00 00 00 70 31 60 00 00 00 00 00     2.......p1`.....
  603140:	b0 31 60 00 00 00 00 00 00 00 00 00 00 00 00 00     .1`.............

0000000000603150 <n32>:
  603150:	16 00 00 00 00 00 00 00 70 32 60 00 00 00 00 00     ........p2`.....
  603160:	30 32 60 00 00 00 00 00 00 00 00 00 00 00 00 00     02`.............

0000000000603170 <n33>:
  603170:	2d 00 00 00 00 00 00 00 d0 31 60 00 00 00 00 00     -........1`.....
  603180:	90 32 60 00 00 00 00 00 00 00 00 00 00 00 00 00     .2`.............

0000000000603190 <n31>:
  603190:	06 00 00 00 00 00 00 00 f0 31 60 00 00 00 00 00     .........1`.....
  6031a0:	50 32 60 00 00 00 00 00 00 00 00 00 00 00 00 00     P2`.............

00000000006031b0 <n34>:
  6031b0:	6b 00 00 00 00 00 00 00 10 32 60 00 00 00 00 00     k........2`.....
  6031c0:	b0 32 60 00 00 00 00 00 00 00 00 00 00 00 00 00     .2`.............

00000000006031d0 <n45>:
  6031d0:	28 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     (...............
	...

00000000006031f0 <n41>:
  6031f0:	01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     ................
	...

0000000000603210 <n47>:
  603210:	63 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     c...............
	...

0000000000603230 <n44>:
  603230:	23 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     #...............
	...

0000000000603250 <n42>:
  603250:	07 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     ................
	...

0000000000603270 <n43>:
  603270:	14 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     ................
	...

0000000000603290 <n46>:
  603290:	2f 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00     /...............
	...

00000000006032b0 <n48>:
  6032b0:	e9 03 00 00 00 00 00 00 00 00 00 00 00 00 00 00     ................
	...

00000000006032d0 <node1>:
  6032d0:	4c 01 00 00 01 00 00 00 e0 32 60 00 00 00 00 00     L........2`.....

00000000006032e0 <node2>:
  6032e0:	a8 00 00 00 02 00 00 00 f0 32 60 00 00 00 00 00     .........2`.....

00000000006032f0 <node3>:
  6032f0:	9c 03 00 00 03 00 00 00 00 33 60 00 00 00 00 00     .........3`.....

0000000000603300 <node4>:
  603300:	b3 02 00 00 04 00 00 00 10 33 60 00 00 00 00 00     .........3`.....

0000000000603310 <node5>:
  603310:	dd 01 00 00 05 00 00 00 20 33 60 00 00 00 00 00     ........ 3`.....

0000000000603320 <node6>:
  603320:	bb 01 00 00 06 00 00 00 00 00 00 00 00 00 00 00     ................
	...

0000000000603340 <host_table>:
  603340:	29 26 40 00 00 00 00 00 43 26 40 00 00 00 00 00     )&@.....C&@.....
  603350:	5d 26 40 00 00 00 00 00 00 00 00 00 00 00 00 00     ]&@.............
	...
